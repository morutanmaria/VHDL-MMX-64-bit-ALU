...
HD_PWD='C:/Uni/An III/Semester I/Structure of Computer Systems/Lab/MMX/MMX.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mmx_basys.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mmx_basys.tcl
