...
HD_PWD='C:/Uni/An III/Semester I/Structure of Computer Systems/Lab/MMX/MMX.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log mmx_basys.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source mmx_basys.tcl -notrace
